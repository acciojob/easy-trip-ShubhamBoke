...
public class AirportController {
    ...
    public String addAirport(@RequestBody Airport airport){
        ...
        if(airportService.addAirport(airport))
            return "SUCCESS";
        return airport.getCity() + " already has an airport or give a different name";
    }
    ...
    public int getNumberOfPeopleOn(@PathVariable("date") Date date,@RequestParam("airportName")String airportName){
        ...
        return airportService.getTotalPeopleOnAirport(date, airportName);
    }
    ...
    public String bookATicket(@RequestParam("flightId")Integer flightId,@RequestParam("passengerId")Integer passengerId){
        ...
        if(airportService.bookTicket(flightId, passengerId)){
            return "SUCCESS";
        }
        return "FAILURE";
    }
    ...
    public String cancelATicket(@RequestParam("flightId")Integer flightId,@RequestParam("passengerId")Integer passengerId){
        ...
        if(airportService.cancelTicket(flightId, passengerId))
            return "SUCCESS";
       return "FAILURE";
    }
    ...
    public int countOfBookingsDoneByPassengerAllCombined(@PathVariable("passengerId")Integer passengerId){
       ...
       return airportService.getTicketCountByPassenger(passengerId);
    }
    ...
    public String addFlight(@RequestBody Flight flight){
        ...
        if(airportService.addFlight(flight))
            return "SUCCESS";
    ...
    public String addPassenger(@RequestBody Passenger passenger){
        ...
        if(airportService.addPassenger(passenger))
            return "SUCCESS";
       return "Passenger addition failed";
    }
